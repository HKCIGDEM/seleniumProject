...
public class T3_GoogleSearch {
    public static void main(String[] args) throws InterruptedException {
        ...
        // this simulates in google page to click "I agree" or "Accept" button
        ...
        googleSearchBox.sendKeys("apple" + Keys.ENTER);// it will send this text  as a String and then it will press "Enter"

...
public class T5_WindowsPractice {
    ...
    public void multiple_windows_test() {
        ...
        System.out.println("Title before click: " + driver.getTitle()); //==>>> Title before click: Windows
        ...
        System.out.println("Title after click: " + driver.getTitle()); //==>> Title after click: Windows
       ...
       for(String each : driver.getWindowHandles()){
        ...
        // if we have to go back to main page to continue our test ase,

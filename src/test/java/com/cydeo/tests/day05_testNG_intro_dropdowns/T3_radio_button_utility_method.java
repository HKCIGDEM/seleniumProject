...
public class T3_radio_button_utility_method {
    public static void main(String[] args) throws InterruptedException {
        ...
        //click and verify football radio button is selected
        clickAndVerifyRadioButton(driver, "sport","football");

        //click and verify colors radio button is selected
 ...
 */
    public static void clickAndVerifyRadioButton(WebDriver driver, String nameAttribute, String expectedID) {
        ...
        //Locate all-of the 'sport' radio buttons, and store them in a List<WebElement>

...
public class T1_Registration_form {
    ...
    public void registration_form() {
        ...
        //5. Enter username
        WebElement inputuUsername = Driver.getDriver().findElement(By.xpath("//input[@name='username']"));
        inputuUsername.sendKeys("janedeo58");
        ...
        inputPhoneNumber.sendKeys("444-555-6666");
